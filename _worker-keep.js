// 环境变量配置(必填)
let email = "6wuxk@tiffincrane.com";      // SAP登录邮箱,直接填写或设置环境变量，变量名：EMAIL
let password = "W_gang69";   // SAP登录密码,直接填写或设置环境变量，变量名：PASSWORD
...
const MONITORED_APPS = [ // 格式: {url: "应用URL", name: "应用名称"}
  {url: "https://https://free-sgramkmz.cfapps.ap21.hana.ondemand.com", name: "free-sgramkmz"},  
  {url: "https://free-usgbjixb.cfapps.us10-001.hana.ondemand.com", name: "free-usgbjixb"}
];
